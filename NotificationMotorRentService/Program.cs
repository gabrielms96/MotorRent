...
using NotificationMotorRentService.EventProcessor;
using NotificationMotorRentService.RabbitMqClient;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "NotificationMotorRentService", Version = "v1" });
});
